...
#really??? NO nestbox data was collected anywhere else (e.g. in NC) from multi-year broods? Nope! Only one county of overlap in the 2024 emergence, somewhere in Indiana
